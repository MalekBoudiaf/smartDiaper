...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_UUID_128   (0x0Au)
 ...
 */
#define CY_BLE_SMARTDIAPER_SERVICE_INDEX   (0x00u) /* Index of smartDiaper service in the cy_ble_customs array */
#define CY_BLE_SMARTDIAPER_READINGS_CHAR_INDEX   (0x00u) /* Index of readings characteristic */
#define CY_BLE_SMARTDIAPER_READINGS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_SMARTDIAPER_POWER_MODE_CHAR_INDEX   (0x01u) /* Index of power_mode characteristic */


#define CY_BLE_SMARTDIAPER_SERVICE_HANDLE   (0x0010u) /* Handle of smartDiaper service */
#define CY_BLE_SMARTDIAPER_READINGS_DECL_HANDLE   (0x0011u) /* Handle of readings characteristic declaration */
#define CY_BLE_SMARTDIAPER_READINGS_CHAR_HANDLE   (0x0012u) /* Handle of readings characteristic */
#define CY_BLE_SMARTDIAPER_READINGS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_SMARTDIAPER_POWER_MODE_DECL_HANDLE   (0x0014u) /* Handle of power_mode characteristic declaration */
#define CY_BLE_SMARTDIAPER_POWER_MODE_CHAR_HANDLE   (0x0015u) /* Handle of power_mode characteristic */
