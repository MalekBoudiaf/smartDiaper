...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        0x6Fu, 0x63u, 0x4Cu, 0x11u, 0x07u, 0xE0u, 0x03u,
        0x33u, 0x37u, 0xB7u, 0xA9u, 0xA8u, 0xA3u, 0xDFu,
        0x48u, 0x63u, 0x97u, 0x27u, 0x49u, 0x76u, 0xF4u,
...
static uint8_t cy_ble_attValues[0x18u] = {
    /* Device Name */
    (uint8_t)'p', (uint8_t)'s', (uint8_t)'o', (uint8_t)'c', (uint8_t)'L', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* smartDiaper */
    { 0xE0u, 0x03u, 0x33u, 0x37u, 0xB7u, 0xA9u, 0xA8u, 0xA3u, 0xDFu, 0x48u, 0x63u, 0x97u, 0x27u, 0x49u, 0x76u, 0xF4u },
    /* readings */
    { 0xA1u, 0x6Eu, 0x82u, 0x9Au, 0x15u, 0x8Eu, 0x10u, 0x97u, 0x2Eu, 0x4Fu, 0xC4u, 0xB9u, 0x98u, 0x48u, 0x04u, 0xCAu },
    /* power_mode */
    { 0xF2u, 0x59u, 0x33u, 0x8Du, 0x96u, 0x84u, 0x99u, 0x8Fu, 0x7Bu, 0x46u, 0x42u, 0x85u, 0x21u, 0xA3u, 0xC0u, 0x83u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Du] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* smartDiaper UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* readings UUID */
    { 0x0002u, (void *)&cy_ble_attValues[21] }, /* readings */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* power_mode UUID */
    { 0x0001u, (void *)&cy_ble_attValues[23] }, /* power_mode */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x15u] = {
    ...
    { 0x0012u, 0x4898u /* readings                            */, 0x09120001u /* rd,ntf */, 0x0013u, {{0x0002u, (void *)&cy_ble_attValuesLen[9]}} },
    ...
    { 0x0015u, 0xA321u /* power_mode                          */, 0x09080100u /* wr     */, 0x0015u, {{0x0001u, (void *)&cy_ble_attValuesLen[12]}} },
};
