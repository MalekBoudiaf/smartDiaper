...
static const cy_stc_ble_customs_t cy_ble_customs[0x01u] = {
    ...
    /* smartDiaper service */
    {
        0x0010u, /* Handle of the smartDiaper service */ 
        {

            /* readings characteristic */
            {
                0x0012u, /* Handle of the readings characteristic */ 
            ...
            /* power_mode characteristic */
            {
                0x0015u, /* Handle of the power_mode characteristic */ 
